...
public class WordleGame {
    public static void main(String[] args) throws IOException {
        ...
        String[] shortlist = {"raster","tyler","point"}; //{"state", "tacks"};
//        Wordle puzzle = new Wordle(shortlist);
        Wordle puzzle = new Wordle("wordle-handout/norvig3.txt", 5, 0, 810514085);
        System.out.println("Game 1 known words: " + puzzle.getKnownWords());
        puzzle.initGame();
